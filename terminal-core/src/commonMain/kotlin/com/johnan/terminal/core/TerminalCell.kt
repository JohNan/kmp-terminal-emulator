...
sealed class TerminalColor {
    ...
    companion object {
        ...
        fun buildStandard(code: Int): Standard {
            return if (code in 0..15) STANDARD_INSTANCES[code] else Standard(code)
        }
        ...
        fun buildPalette256(code: Int): Palette256 {
            return if (code in 0..255) PALETTE_256_INSTANCES[code] else Palette256(code)
        }
        ...
        private fun getStandardColor(code: Int, isDark: Boolean): Color {
        ...
        private fun computeStandardColor(code: Int, isDark: Boolean): Color {
            return when (code) {
                0 -> Color(0xFF000000)
                1 -> Color(0xFFCD0000)
                2 -> Color(0xFF00CD00)
        ...
        private fun get256Color(code: Int): Color {
            return if (code in 0..255) PALETTE_256_CACHE[code] else Color(0xFFE0E0E0)
        }
